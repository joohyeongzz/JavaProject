...
// import는 외부의 클래스를 이 파일에 가져와 사용하겠다는 의미
// java.utill.Scanner : java 패키지 내부의 utill 패키지에 들어있는 Scanner 클래스를 사용하겠다.
...
public class B01_Scanner {
	...
	public static void main(String[] args) {
		...
		// 입력한 문자열을 한 줄 읽어 들임.
		System.out.print(">> ");
		String line = scan.nextLine();  // 참조형 타입의 변수에 "."을 찍은 후에 해당 참조형을 참조.
		System.out.println("사용자가 입력한 문자열 : "+line);
		
		// 참조형 타입 변수에 .을 찍고, ctrl + space 로 그 타입에 사용할 수 있는 기능(함수)을 볼 수 있음.
