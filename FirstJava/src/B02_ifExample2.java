...
public class B02_ifExample2 {
	...
	public static void main(String[] args) {
		...
		// if ~ else문 : if 조건문이 true면 if의 종속 실행문을, 그렇지 않으면 else의 실행문을 동작
