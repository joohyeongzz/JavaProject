...
public class A04_varType {
	...
	public static void main(String[] args) {
		 ...
		 *    - 4byte (int)
		 *      signed : -2^31 ~ 2^31-1 , unsigned : 0 ~ 4294967295
		 *    - 8byte (long) 
		 *      signed : -2^63 ~ 2^63-1
		 */
		...
		long _long = 22_0000_0000L; // long은 정수 뒤에 L(l)을 붙여야 함
		 ...
		 *   - 복잡하고 정확한 수의 계산이 필요한 분야에서 주로 사용됨
		 *   - 부동소수점 방식을 사용함.
		 *   
		 *   - float (4byte)
		 *   - double (8byte) **기본타입
