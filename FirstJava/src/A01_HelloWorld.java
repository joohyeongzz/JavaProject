 ...
 *   Tab키를 적절하게 할용하여 코드를 보기 좋게 만들어야 한다
 *   Shift + Tab : 역탭
 *   Ctrl + Z : 되돌리기
 *   Ctrl + Y : 되돌리기 취소
 *   Ctrl + M : 화면 넓게 쓰기
 ...
 *   
 *   블록 지정 관련 단축키
 *   HOME키 : 줄의 맨 앞으로 커서를 이동
 *   END 키 : 줄의 맨 뒤로 커서를 이동
 *   Shift키를 누른 상태로 커서 이동 : 블록 지정
 *   Ctrl + A : 전체 블록 지정
 *   
 *   
 *     
...
public class A01_HelloWorld {
	...
	public static void main(String[] args) { // {}(중괄호) 블럭은 여러 명령어가 묶여 있는 부분 (복합적 구성 요소)
	    ...
	    System.out.println("11.1101");
	    // "" : 사이에 있는 내용은 문자열
	    
	    System.out.println(1234); // 숫자 : 정수형	 
	    System.out.println(); // 아무것도 입력하지 않으면 줄바꿈만 동작함
	    
	    System.out.println('A'); // ' ' : 사이에 있는 내용은 문자형(문자형은 단 하나의 글자만 존재)
