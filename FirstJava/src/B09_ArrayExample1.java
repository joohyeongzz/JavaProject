...
public class B09_ArrayExample1 {
	...
	public static void main(String[] args) {
		...
		boolean[] win = {true, false, false, false, true}; // boolean타입의 변수 5개 저장 및 초기화
		String[] welcome = new String[] {
				"오늘 뭐 드셨어요?", "오늘 저녁에 비 온대요.", "졸리죠"
		};
...
//		char[5] s2;		// 배열 선언시 오류
		...
		for (int i = 0; i< win.length; i++) {
			if(win[i]) {
				System.out.println(i+1 + " 번 째 전적 : 승리");
			}else {
				System.out.println(i+1 + " 번 째 전적 : 패배");
			}
		}
		System.out.println();
