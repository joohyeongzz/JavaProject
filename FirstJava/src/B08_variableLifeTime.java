...
public class B08_variableLifeTime {
	static int c; // 클래스 멤버변수 - 클래스에 직접 사용하는 변수로 객체 생성과 무관
	int b = 8;	  // 인스턴스 멤버변수(필드, 속성...) - 객체가 생성되어야 사용 가능
	
	public static void main(String[] args) {
		// 변수 수명
		
		// {} 블럭 내부에서 선언된 변수는 '지역변수'로 {}을 벗어나면 사라집니다.
		// 변수가 살아 있는 범위를 변수의 영역(Scope)이라고 불브니다.
		...
		obj2.b = 100; 	// obj2 객체의 b인스턴스 변수의 값을 수정
		System.out.println("class의 b : " + obj.b);
		...
		System.out.println("대입한 후 : " +obj.c);
		System.out.println("대입한 후 : " +obj2.c);
		System.out.println();
		...
		if(true) {
			...
			a = 7;
			System.out.println("메인 메서드의 b : " + b);
